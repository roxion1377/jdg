...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { input: @detail.input, memory: @detail.memory, output: @detail.output, result_id: @detail.result_id, state: @detail.state, time: @detail.time }
    end
  ...
  test "should update detail" do
    put :update, id: @detail, detail: { input: @detail.input, memory: @detail.memory, output: @detail.output, result_id: @detail.result_id, state: @detail.state, time: @detail.time }
    assert_redirected_to detail_path(assigns(:detail))
  end
